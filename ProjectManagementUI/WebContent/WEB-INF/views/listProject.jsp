                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Abc, Pqr</td>
                                        <td>Planning</td>
                                         <td><a href = "/ProjectManagementUI/updateProject"><button type="submit" class="btn btn-success">Update</button></a></td>
                                        <td><button type="submit" class="btn btn-danger">Delete</button></td>
                                        <td><a href = "/ProjectManagementUI/addTask"><button type="submit" class="btn btn-info">Add Tasks</button></a></td>
                                    	<td><a href = "/ProjectManagementUI/listTask"><button type="submit" class="btn btn-primary">List Tasks</button></a></td>
                                    </tr>
                                    <tr>
                                        <td>Project 2</td>
                                        <td>Lklsjldf sbkdbkhf bkdfhk</td>
