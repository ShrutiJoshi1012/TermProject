			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right custom-menu">
						...
						<li><a href="/ProjectManagementUI/login">Login</a></li>
						<li><a href="/ProjectManagementUI/signup">Signup</a></li>
					</ul>
				</div>
			</div>
		</nav>
				...
				<div class="row teamspace">
					<div class="col-xs-12 col-sm-6 col-md-3">
						<div class="team-member">
							<div class="team-img">
								<img class="img-responsive" src="images/shruti.jpg" alt="">
							</div>
							<div class="team-info">
								<h3>Shruti Joshi</h3>
					...
					<div class="col-xs-12 col-sm-6 col-md-3">
						<div class="team-member">
							<div class="team-img">
								<img class="img-responsive" src="images/nikitha.jpg" alt="">
							</div>
							<div class="team-info">
					...
					<div class="col-xs-12 col-sm-6 col-md-3">
						<div class="team-member">
							<div class="team-img">
								<img class="img-responsive" src="images/ruchi.jpg" alt="">
							</div>
							<div class="team-info">
								<h3>Ruchi Shah</h3>
								<span>Team Member</span>
					...
					<div class="col-xs-12 col-sm-6 col-md-3">
						<div class="team-member">
							<div class="team-img">
								<img class="img-responsive" src="images/sudhindra.jpg" alt="">
							</div>
							<div class="team-info">
								<h3>Sudhindra T</h3>
								<span>Team Member</span>
