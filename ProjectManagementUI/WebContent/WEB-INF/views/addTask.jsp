        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="/ProjectManagementUI/dashboard"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="/ProjectManagementUI/createProject">Create Project</a>
                            </li>
                            <li>
                                <a href="/ProjectManagementUI/listProject">List Projects</a>
                            </li>
                            <li>
                                <a href="#">Reports!</a>
                            </li>
            ...
            <div class="container-fluid">
				...
				<div class="row">
                    <div class="col-lg-offset-3 col-lg-5">
                    	 <form role="form" action = "/ProjectManagementUI/listProject" method = "get">
                    	 	<div class="form-group">
                                <label>Task Title:</label>
                                <input class="form-control" placeholder="Give Your Task A Name">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="optionsRadiosInline" id="optionsRadiosInline1" value="option1" checked>New
                                </label>
                            </div>
                            <div class = "form-group">
                            	<label>Estimated Units of work:</label><br>
                            	<input class="form-control" placeholder="Estimated Weeks of Work"/>
                            </div>
