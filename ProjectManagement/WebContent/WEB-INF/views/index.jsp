...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
		...
		<!-- Custom CSS -->
		<link rel="stylesheet" href="${pageContext.servletContext.contextPath}/resources/css/patros.css" >
	...
	<!-- Navigation -->
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#"><b><i><font color = "white">InfoSoft</font></i></b></a>
				</div>
			...
			<ul class="cb-slideshow">
				<li><span>image1</span>
					<div class="container">
						<div class="row">
							<div class="col-lg-12">
								<div class="text-center"><h3>Quote:</h3></div>
							</div>
						</div>
						<h4>"Your work is going to fill a large part of your life, and the only way to be truly satisfied is to do what you believe is great work. And the only way to do great work is to love what you do." - Steve Jobs, Apple Inc. co-founder, chairman and CEO</h4>
					</div>
				</li>
				<li><span>image2</span>
					<div class="container">
						<div class="row">
							<div class="col-lg-12">
								<div class="text-center"><h3>What Do We Serve</h3></div>
							</div>
						</div>
						<h4>We provide best software solutions to our clients. Thrive to provide the best in us with all the available maintenance. Our very supportive team is always there to help!</h4>
					</div>
				</li>
				<li><span>image3</span>
					<div class="container">
						<div class="row">
							<div class="col-lg-12">
								<div class="text-center"><h3>Our Team</h3></div>
							</div>
						</div>
						<h4> We are a group of four who strive to provide best in them always and constantly keep on updating themselves.</h4>
					</div>
				</li>
				<li><span>Image 04</span>
					<div class="container">
						<div class="row">
							<div class="col-lg-12">
								<div class="text-center"><h3>Our Clients</h3></div>
							</div>
						</div>
						<h4>We provide software solutions to multi-national clients.Our clients include Abc, Xyz, Pqr etc.</h4>
					</div>
				</li>
				...
				<div class="row">
					<div class="col-md-offset-1 col-md-10">
						<div class="text-center">
							<h2>About Us</h2>
							<img class="img-responsive displayed" src="${pageContext.servletContext.contextPath}/resources/images/short.png" alt="Company about"/>
							<div class="row">
								<div class="col-md-12">
									<p>
										At InfoSoft we all constantly strive to serve the problems that are faced by many companies which is keeping their data secure. We all constantly work to provide the best data and software security solutions to our customers. We love to see the satisfaction on our clients faces when they use our products.
									</p>
								</div>
							</div>
						</div>
		...
		<section id="meet-team">
			<div class="container">
				<div class="text-center">
				<h2>Team Members</h2>
				<img class="img-responsive displayed" src="${pageContext.servletContext.contextPath}/resources/images/short.png" alt="about">
				</div>
				<div class="row teamspace">
					<div class="col-xs-12 col-sm-6 col-md-3">
						<div class="team-member">
							<div class="team-img">
								<img class="img-responsive" src="${pageContext.servletContext.contextPath}/resources/images/shruti.jpg" alt="">
							</div>
							<div class="team-info">
								<h3>Shruti Joshi</h3>
					...
					<div class="col-xs-12 col-sm-6 col-md-3">
						<div class="team-member">
							<div class="team-img">
								<img class="img-responsive" src="${pageContext.servletContext.contextPath}/resources/images/nikitha.jpg" alt="">
							</div>
							<div class="team-info">
					...
					<div class="col-xs-12 col-sm-6 col-md-3">
						<div class="team-member">
							<div class="team-img">
								<img class="img-responsive" src="${pageContext.servletContext.contextPath}/resources/images/ruchi.jpg" alt="">
							</div>
							<div class="team-info">
								<h3>Ruchi Shah</h3>
								<span>Team Member</span>
					...
					<div class="col-xs-12 col-sm-6 col-md-3">
						<div class="team-member">
							<div class="team-img">
								<img class="img-responsive" src="${pageContext.servletContext.contextPath}/resources/images/sudhindra.jpg" alt="">
							</div>
							<div class="team-info">
								<h3>Sudhindra T</h3>
								<span>Team Member</span>
							...
							<div class="row">
								...
								<div class="col-md-12 height-contact-element">    
									<div class="form-group">
										...
										<span class="text">info@infosoft.com</span>
									</div>
								</div>
							</div>
						</div>
		...
		<section id="follow-us">
			<div class="container"> 
				...
				<img class="img-responsive displayed" src="${pageContext.servletContext.contextPath}/resources/images/short.png" alt="short" />
				<div class="text-center height-contact-element">
		...
		<!-- Portfolio -->
		<script src="${pageContext.servletContext.contextPath}/resources/js/jquery.quicksand.js"></script>	    
