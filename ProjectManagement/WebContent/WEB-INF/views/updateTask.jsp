						...
						<form role="form"
							...
							<div class="form-group">
								<label>Estimated Work:</label> <input class="form-control"
									name="estimatedwork"
									value="<% out.print(task.getEstimatedWork());%>"
									readonly>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<textarea class="form-control" name="description"><%out.print(task.getTaskDetail().getDescription());%></textarea>
							</div>
							<div class="form-group">
								<label>Assignees: <br></label> <select class="form-group"
									...
									<option value=""> -- Select an assignee from the Team -- </option>
									<option value="<% out.print(task.getProject().getOwner().getEmailid());%> ">
							...
							<div class="form-group">
								<label>Task State: </label><br> <label class="radio-inline">
									<input type="radio" name="state" id="optionsRadiosInline1"
									value="Assigned" checked>Assigned
